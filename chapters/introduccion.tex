...
\noindent
El ser humano es difícil. Desde una perspectiva computacional, cualquier persona realiza tareas que constituyen\
...
Si a lo establecido en el último enunciado del párrafo anterior se le suma la tendencia a elaborar modelos\
...
\begin{figure}
  ...
  \caption{El zoológico de redes neuronales conocido hasta 2016.
    Tomado del sitio web de \href{http://www.asimovinstitute.org}{The Asimov Institute}
    \cite{website:theasimovinstitute}.
  }
\end{figure}

\section{Objetivos y metas de la tesis}
...
\item Evaluar el desempeño de la salida de la red, asociando imagen con leyenda. Hacer cuantas iteraciones\
  sean necesarias para mejorar la calidad de los memes producidos por la misma.
\end{itemize}
